...
var require_words = __commonJS({
  "node_modules/.pnpm/random-word-slugs@0.1.7/node_modules/random-word-slugs/dist/words.js"(exports2) {
    "use strict";
    ...
    exports2.getWordsByCategory = exports2.wordList = void 0;
    exports2.wordList = {
      noun: [
    ...
    function getWordsByCategory(partOfSpeech, categories) {
      ...
      var selectedWords = [];
      try {
        for (var _b = __values(exports2.wordList[partOfSpeech]), _c = _b.next(); !_c.done; _c = _b.next()) {
          var word = _c.value;
    ...
    exports2.getWordsByCategory = getWordsByCategory;
  }
});

// node_modules/.pnpm/random-word-slugs@0.1.7/node_modules/random-word-slugs/dist/index.js
var require_dist = __commonJS({
  "node_modules/.pnpm/random-word-slugs@0.1.7/node_modules/random-word-slugs/dist/index.js"(exports2) {
    "use strict";
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.totalUniqueSlugs = exports2.generateSlug = void 0;
    ...
    exports2.generateSlug = generateSlug2;
    ...
    exports2.totalUniqueSlugs = totalUniqueSlugs;
  }
});
...
describe("generateRandomSlugs", () => {
  it("should generate the correct number of slugs", () => {
    const count = 10;
    const slugs2 = generateRandomSlugs(count);
    expect(slugs2.length).toBe(count);
  });
  it("should generate an array of strings", () => {
    const slugs2 = generateRandomSlugs(5);
    slugs2.forEach((slug) => {
